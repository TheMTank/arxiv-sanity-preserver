...
print('Beginning create_elastic_database function')
# load the existing database to memory
try:
...
all_papers_txt_file_paths = glob.glob(os.path.join(Config.txt_dir, "*"))
